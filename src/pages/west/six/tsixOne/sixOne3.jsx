      ...
      <div style={{ position: "sticky", top: "5px" }}>
        <Nav>
          <NavMenu>
            ...
            <h1>Т 6.1 - выдающиеся</h1>
            <NavLink to="/sixOne" activeStyle>
              1
            </NavLink>
            <NavLink to="/sixOne2" activeStyle>
              2
            </NavLink>
            <NavLink to="/sixOne3" activeStyle>
              3
            </NavLink>
            <NavLink to="/sixOne4" activeStyle>
              4
            </NavLink>
            <NavLink to="/sixOne5" activeStyle>
              5
            </NavLink>
            <h1>Сервер: WEST</h1>
          </NavMenu>

...
function Maunt() {
  ...
  function addFitch() {
    fetch(
      `https://EAST.albion-online-data.com/api/v2/stats/prices/T2_MOUNT_MULE.json?locations=Caerleon,BlackMarket,Martlock,Thetford,Lymhurst,FortSterling,Bridgewatch&qualities=3`
    )
      .then((res) => res.json())
      .then((json) => analysisJSON(json));
    fetch(
      `https://EAST.albion-online-data.com/api/v2/stats/prices/T3_MOUNT_HORSE,T3_MOUNT_OX,.json?locations=Caerleon,BlackMarket,Martlock,Thetford,Lymhurst,FortSterling,Bridgewatch&qualities=3`
    )
      .then((res) => res.json())
      .then((json) => mauntt3(json));
    fetch(
      `https://EAST.albion-online-data.com/api/v2/stats/prices/T4_MOUNT_HORSE,T4_MOUNT_OX,T4_MOUNT_GIANTSTAG.json?locations=Caerleon,BlackMarket,Martlock,Thetford,Lymhurst,FortSterling,Bridgewatch&qualities=3`
    )
      .then((res) => res.json())

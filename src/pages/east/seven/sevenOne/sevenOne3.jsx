        ...
        <>
          <Nav>
            <NavMenu>
              ...
              <h1>Т 7.1 - выдающиеся</h1>
              <NavLink to="/sevenOneE" activeStyle>
                1
              </NavLink>
              <NavLink to="/sevenOne2E" activeStyle>
                2
              </NavLink>
              <NavLink to="/sevenOne3E" activeStyle>
                3
              </NavLink>
              <NavLink to="/sevenOne4E" activeStyle>
                4
              </NavLink>
              <NavLink to="/sevenOne5E" activeStyle>
                5
              </NavLink>
              <h1>Сервер: EAST</h1>
            </NavMenu>

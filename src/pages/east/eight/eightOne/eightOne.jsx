...
function App() {
  ...
  function addFitch() {
    ...
    fetch(
      `https://east.albion-online-data.com/api/v2/stats/prices/T8_SHOES_PLATE_UNDEAD@1,T8_ARMOR_PLATE_UNDEAD@1,T8_HEAD_PLATE_UNDEAD@1,T8_SHOES_CLOTH_KEEPER@1,T8_ARMOR_CLOTH_KEEPER@1,T8_HEAD_CLOTH_KEEPER@1,T8_SHOES_LEATHER_MORGANA@1,T8_ARMOR_LEATHER_MORGANA@1,T8_HEAD_LEATHER_MORGANA.json?locations=Caerleon,BlackMarket,Martlock,Thetford,Lymhurst,FortSterling,Bridgewatch&qualities=${qualities}`
    )
      .then((res) => res.json())

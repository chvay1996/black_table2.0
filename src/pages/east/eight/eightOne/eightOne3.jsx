    ...
    <>
      <div style={{ position: "sticky", top: "80px" }}>
        ...
        <div>
          <Nav>
            <NavMenu>
              <h1>Т 8.1 - выдающиеся</h1>
              <NavLink to="/eightOneE" activeStyle>
                1
              </NavLink>
              <NavLink to="/eightOne2E" activeStyle>
                2
              </NavLink>
              <NavLink to="/eightOne3E" activeStyle>
                3
              </NavLink>
              <NavLink to="/eightOne4E" activeStyle>
                4
              </NavLink>
              <NavLink to="/eightOne5E" activeStyle>
                5
              </NavLink>
              <h1>Сервер: EAST</h1>
            </NavMenu>

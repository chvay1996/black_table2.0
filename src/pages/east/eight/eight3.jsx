    ...
    <>
      <div style={{ position: "sticky", top: "80px" }}>
        ...
        <div>
          <Nav>
            <NavMenu>
              <h1>Т 8.0 - выдающиеся</h1>
              <NavLink to="/eighEt" activeStyle>
                1
              </NavLink>
              <NavLink to="/eight2E" activeStyle>
                2
              </NavLink>
              <NavLink to="/eight3E" activeStyle>
                3
              </NavLink>
              <NavLink to="/eight4E" activeStyle>
                4
              </NavLink>
              <NavLink to="/eight5E" activeStyle>
                5
              </NavLink>
              <h1>Сервер: EAST</h1>
            </NavMenu>

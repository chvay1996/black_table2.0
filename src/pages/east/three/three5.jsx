...
function App() {
  ...
  function addFitch() {
    fetch(
      `https://east.albion-online-data.com/api/v2/stats/prices/T3_HEAD_CLOTH_SET1,T3_ARMOR_CLOTH_SET1,T3_SHOES_CLOTH_SET1,T3_OFF_BOOK,T3_HEAD_LEATHER_SET1,T3_ARMOR_LEATHER_SET1,T3_SHOES_LEATHER_SET1,T3_2H_BOW,T3_MAIN_FROSTSTAFF,T3_MAIN_SPEAR,T3_MAIN_DAGGER,T3_OFF_TORCH,T3_HEAD_PLATE_SET1,T3_ARMOR_PLATE_SET1,T3_SHOES_PLATE_SET1,T3_MAIN_SWORD,T3_MAIN_AXE,T3_MAIN_MACE,T3_2H_TOOL_SIEGEHAMMER,T3_2H_CROSSBOW,T3_OFF_SHIELD,T3_BAG,T3_CAPE.json?locations=Caerleon,BlackMarket,Martlock,Thetford,Lymhurst,FortSterling,Bridgewatch&qualities=5`
    )
      .then((res) => res.json())
